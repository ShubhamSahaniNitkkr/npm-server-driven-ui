...
Core engine for Server Driven UI in React.
...
Full docs: [github.com/shubhamsunnynitkkr/npm-server-driven-ui](https://github.com/shubhamsunnynitkkr/npm-server-driven-ui)
